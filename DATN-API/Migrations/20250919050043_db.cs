        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CitizenIdentityCard = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MoneyAmout = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    BankAccountOwner = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTradingPayments", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Decorates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Decorates_AdminSettings_AdminSettingId",
                        column: x => x.AdminSettingId,
                        principalTable: "AdminSettings",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Decorates_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdminSettingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Policies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Policies_AdminSettings_AdminSettingId",
                        column: x => x.AdminSettingId,
                        principalTable: "AdminSettings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FollowStores_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FollowStores_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatingStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatingStores_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RatingStores_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyAllCategories = table.Column<bool>(type: "bit", nullable: false),
                    ApplyAllProducts = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceReduce = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductImages_ProductVariants_ProductVariantsId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductImages_Variants_ProductVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariantCompositions", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VariantCompositions_ProductVariants_ProductVariantsId",
                        column: x => x.ProductVariantsId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VariantCompositions_VariantValues_VariantValueId",
                        column: x => x.VariantValueId,
                        principalTable: "VariantValues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VariantCompositions_Variants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "Variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    VariantCompositionId = table.Column<int>(type: "int", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.VariantCompositionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AhamoveOrderId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_Prices_PricesId",
                        column: x => x.PricesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Decorates_AdminSettingId",
                table: "Decorates",
                column: "AdminSettingId");

            migrationBuilder.CreateIndex(
                name: "IX_Decorates_UserId",
                table: "Decorates",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowStores_StoreId",
                table: "FollowStores",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_FollowStores_UserId",
                table: "FollowStores",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_AdminSettingId",
                table: "Policies",
                column: "AdminSettingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ProductVariantsId",
                table: "ProductImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantCompositions_ProductVariantId",
                table: "VariantCompositions",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantCompositions_ProductVariantsId",
                table: "VariantCompositions",
                column: "ProductVariantsId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantCompositions_VariantId",
                table: "VariantCompositions",
                column: "VariantId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantCompositions_VariantValueId",
                table: "VariantCompositions",
                column: "VariantValueId");
